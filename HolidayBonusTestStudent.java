...
public class HolidayBonusTestStudent {
    ...
    public void testCalculateTotalHolidayBonusA() {
        // test for each of your data sets
        assertEquals(24000.0, HolidayBonus.calculateTotalHolidayBonus(dataSet1, 5000, 1000, 2000),.001);
        assertEquals(22000.0, HolidayBonus.calculateTotalHolidayBonus(dataSet2, 5000, 1000, 2000),.001);
    ...
    public void testCalculateTotalHolidayBonusB() {
        // test for each of your data sets
        assertEquals(5000.0, HolidayBonus.calculateTotalHolidayBonus(dataSet1, 1000, 250, 500), .001);
        assertEquals(4500.0, HolidayBonus.calculateTotalHolidayBonus(dataSet2, 1000, 250, 500), .001);
